...
function CartSidebar() {
  ...
  const wrapperTitleId = 'cart-sidebar-title'
  ...
  if (!cartOpen) {
    // Mantener el markup simple; el CSS ya oculta/posiciona.
    // Se deja render de overlay/sidebar igual que antes.
  }
  ...
  return (
    <>
      ...
      <div
        ...
        role="dialog"
        aria-modal="true"
        aria-labelledby={wrapperTitleId}
      >
        <div className="cart-sidebar__header">
          <h2>
            ...
            <span id={wrapperTitleId}>Carrito de compras</span>
          </h2>
          <button className="cart-close" onClick={close} type="button" ref={closeBtnRef}>
            <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
          ...
          {cart.length === 0 ? (
            ...
            cart.map((item) => (
              <div key={item.id} className="cart-item">
                ...
                <div className="cart-item__info">
                  ...
                  <div className="cart-item__row">
                    <div className="qty-control">
                      <button className="qty-btn" onClick={() => changeQty(item.id, -1)} type="button">
                ...
                <button className="cart-item__remove" onClick={() => removeFromCart(item.id)} type="button">
        ...
        {cart.length > 0 && (
          <div className="cart-sidebar__footer">
            ...
            <p className="cart-free-shipping">
              {shipping > 0
                ? `Agrega $${(100 - cartSubtotal).toFixed(2)} más para envío gratis`
                : '¡Tienes envío gratis! 🎉'}
            </p>
          </div>
        )}
